...
export function DatabaseSync() {
  ...
  useEffect(() => {
    ...
    // Get archived areas from localStorage for now since we don't sync them perfectly yet
    const storedProfile = JSON.parse(localStorage.getItem("currentUserProfile") || "{}")
    const archivedAreas = storedProfile.archivedAreas || []
